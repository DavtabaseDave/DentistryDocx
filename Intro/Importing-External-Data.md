...
1. Give user the option to clear out the `All_MMI_Rankings$` (for when they're NOT appending new rankings). 
Also to clear out the User table
...
1. Give user the option to clear out the `MMI_Schedule$` (for when they're NOT appending new rows).
...
1. Give user the option to clear out the `Practique_finalscores$` (for when they're NOT appending new rows).
Also to clear out the User table
